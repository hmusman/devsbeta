<div class='add_comment_area mt-4'>
    <h5 class='text-start'>Add a comment</h5>
    <form method='post' action='{{route("blogetc.comments.add_new_comment", $post->slug)}}'>
        ...
        <div class="form-group ">
            ...
            <label style="padding-left:0px;" id="comment_label" for="comment" style="padding-left:0px;">Your Comment </label>
                    <textarea
                            class="form-control"
                            name='comment'
                            required
            ...
            <div class='row'>
                ...
                @if(config("blogetc.comments.save_user_id_if_logged_in", true) == false || !\Auth::check())
                    ...
                    <div class='col-sm-4 col-xs-12'>
                        <div class="form-group ">
                            <label style="padding-left:0px;" id="author_name_label" for="author_name">Your Name </label>
                            <input
                                    type='text'
                                    class="form-control"
                                    name='author_name'
                    ...
                    @if(config("blogetc.comments.ask_for_author_email"))
                        <div class='col-sm-4 col-xs-12'>
                            <div class="form-group">
                                <label style="padding-left:0px;" id="author_email_label" for="author_email">Your Email
                ...
                @if(config("blogetc.comments.ask_for_author_website"))
                    <div class='col-sm-4 col-xs-12'>
                        <div class="form-group">
                            <label style="padding-left:0px;" id="author_website_label" for="author_website">Your Website
