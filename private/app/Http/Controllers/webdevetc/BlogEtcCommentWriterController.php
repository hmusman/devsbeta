...
class BlogEtcCommentWriterController extends Controller
{
    ...
    public function addNewComment(AddNewCommentRequest $request, $blog_post_slug)
    {
        ...
        return back()->With("success",'<div class="alert alert-success"><strong>Thanks! Your comment has been saved!</strong><p>After an admin approves the comment, it\'ll appear on the site!</p></div>');
