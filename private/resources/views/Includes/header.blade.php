...
<html lang="en">
	<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
		...
		<meta name="description" content="Our professional team converts your ideas into a brand with their skills. We offer web development, web & graphic designing, Application development, SEO services & IT.">
		<meta name="keywords" content="DESIGN & DEVELOPMENT DESIGN, DEVELOPMENT & SEO Android SOCIAL MANAGEMENT & MARKETING Customization Plugin & Theme Development">
	...
	<body>
		<div id="ssb-container" class="ssb-btns-right ssb-anim-slide">
			<ul class="ssb-light-hover">
				...
				<li id="ssb-btn-2">
					<p>
						<a href="skype:usman_gcuf?call" class="bordered"><span><img src="https://img.icons8.com/small/24/ffffff/skype.png"></span> Skype</a>
					</p>
				</li>
				<li id="ssb-btn-0">
					<p>
						<a href="tel:+923339941145" class="bordered"><span><img src="https://img.icons8.com/small/24/ffffff/phone.png"></span> Call Us</a>
					</p>
				</li>
				<li id="ssb-btn-1">
					<p>
						<a href="https://wa.me/923339941145"><span><img src="https://img.icons8.com/small/24/ffffff/whatsapp.png"></span> Whatsapp</a>
					</p>
				</li>
			</ul>
		</div>
		<div class="offcanvas-container is-triggered offcanvas-container-reverse" id="mobile-menu">
			...
			<div class="offcanvas-scrollable-area border-top" style="height:calc(100% - 235px); top: 144px;">
				<div class="accordion mobile-menu" id="accordion-menu">
					...
					<div class="card">
						<div class="card-header">
							<a class="mobile-menu-link @if(Request::is('blog')) active @endif" href="{{url('blog')}}">Blog</a>
						</div>
					</div>
				</div>
			</div>
...
>>>>>>> fa34a0d3094385f7206885b0d706a06e86e84117
            </div>
		</div>
		<header class="navbar-wrapper navbar-boxed navbar-sticky">
			<div class="container-fluid">
				<div class="d-table-cell align-middle pr-md-3">
					<a class="navbar-brand mr-1" href="{{ url('/') }}"><img src="{{url('assets/img/logo/DevsBeta-Final.png')}}" alt="CreateX"/></a>
				</div>
				<div class="d-table-cell w-100 align-middle pl-md-3">
					<div class="navbar justify-content-end p-3">
						<ul class="navbar-nav d-none d-lg-block">
							...
							<!-- Portfolio-->
							@if(Request::is('portfolio'))
							<li class="nav-item dropdown-toggle active"><a class="nav-link" href="{{url('portfolio')}}">Portfolio</a>
								@else
							<li class="nav-item dropdown-toggle">
								<a class="nav-link" href="{{url('portfolio')}}">Portfolio</a>
								@endif
							...
							@else
							<li class="nav-item mega-dropdown-toggle"><a class="nav-link" href="{{url('contactus')}}">Contact</a>
							</li>
							@endif
							<!-- Shop-->
							@if(Request::is('about'))
							<li class="nav-item mega-dropdown-toggle active"><a class="nav-link" href="{{url('about')}}">About</a>
							</li>
							@else
							<li class="nav-item mega-dropdown-toggle"><a class="nav-link" href="{{url('about')}}">About</a>
							</li>
							@endif
							<li class="nav-item mega-dropdown-toggle @if(Request::is('blog')) active @endif"><a class="nav-link" href="{{url('blog')}}">Blog</a>
							</li>
						</ul>
						<div>
							<ul class="navbar-buttons d-inline-block align-middle">
